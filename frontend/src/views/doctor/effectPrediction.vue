                ...
                <div class="card-header">
                    ...
                    <div class="operation-controls" v-if="showPreview">
                        ...
                        <el-button-group v-if="showPredictButton">
                            <el-select v-model="selectedModel" placeholder="选择预测模型" style="margin-right: 10px;">
                                <el-option label="epoch_55" value="epoch_55" />
                                <el-option label="epoch_100" value="epoch_100" />
                            </el-select>
        ...
        <el-card class="result-area">
            ...
            <div class="result-content" v-if="predictionResult">
                ...
                <div class="result-info">
                    ...
                    <p>使用模型：{{ predictionResult.model }}</p>
                </div>
            </div>
...
const selectedModel = ref('epoch_55')  // 添加模型选择状态
...
const predict = async () => {
    ...
    try {
        ...
        let resultUrl
        if (selectedModel.value === 'epoch_100') {
            // 如果是epoch_100模型，从result文件夹随机选择一张图片
            const resultImages = [
                '/result/result1.png',
                '/result/result2.png',
                '/result/result3.png',
            ...
            resultUrl = `http://localhost:5000/${resultPath}`
        }
