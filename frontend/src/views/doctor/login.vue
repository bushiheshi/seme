        ...
        <div class="forms-container">
            <div class="signin-signup">
                <el-form ref="loginRef" :model="loginForm" :rules="loginRules" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <el-form-item prop="mail">
                            <el-input v-model="loginForm.mail" placeholder="邮箱" @keyup.enter="Login(loginForm)" />
                        </el-form-item>
                    </div>
                    <div class="input-field">
                        ...
                        <el-form-item prop="password">
                            <el-input v-model="loginForm.password" type="password" placeholder="密码" autocomplete="off"
                                show-password @keyup.enter="Login(loginForm)" />
                        </el-form-item>
                    </div>
                ...
                <el-form ref="signUpRef" :model="signUpForm" :rules="signUpRules" class="sign-up-form">
                    ...
                    <el-button type="primary" :loading="signUploading" @click="VerifyCode(signUpForm)" class="btn form"
                        round>
